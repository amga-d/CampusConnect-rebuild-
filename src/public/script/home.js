document.addEventListener("DOMContentLoaded", function () {
  ...
  function setupNavigation() {
    ...
    const pageStyles = {
      home: "styles/home/home-dashboard.css",
      discover: "/styles/home/discover.css",
      myCommunities: "/styles/home/myCommunities.css",
      events: "/styles/home/events.css",
      news: "/styles/home/news.css",
      profile: "/styles/home/profile.css",
      newcommunity: "/styles/home/newcommunity.css",
    };
    ...
    const pageScript = {
      ...
      discover: "",
      myCommunities: "",
      events: "/script/home/events.js",
      news: "/script/home/events.js",
      profile: "/script/home/profile.js",
      newcommunity: "/script/home/newcommunity.js",
    };
    ...
    window.loadPage = async function (pageId) {
      try {
        ...
        if (
          pageId.startsWith("community/") ||
          pageId.startsWith("Dashboard/")
        ) {
        ...
        const title =
          titleMap[pageId] || pageId.charAt(0).toUpperCase() + pageId.slice(1);
        navTitle.textContent = title;

        // Remove previously added CSS files
        const existingLink = document.getElementById("dynamicStyles");
        if (existingLink) {
          existingLink.remove();
        }
        ...
        if (cssFilePath) {
          ...
          await new Promise((resolve, reject) => {
            ...
            linkElement.onerror = () => {
              ...
              reject(new Error(`Error loading CSS file: ${cssFilePath}`));
            };
          });
        }
        console.log(pageId);
        ...
        if (scriptPath) {
          ...
          await new Promise((resolve, reject) => {
            ...
            scriptElement.onerror = () => {
              ...
              reject(new Error(`Error loading JS file: ${scriptPath}`));
            };
          });
        }
    ...
    navItems.forEach((item) => {
      item.addEventListener("click", (e) => {
        ...
        if (
          item.classList.contains("plusButton") ||
          item.parentElement.classList.contains("new-community-link")
        ) {
          pageId = "newcommunity";
        }
    ...
    if (
      initialPage.startsWith("community/") ||
      initialPage.startsWith("Dashboard/")
    ) {
